...
jQuery(document).ready(function() {
    ...
    //parallax
	if (jQuery().parallax) {
		jQuery('#future').parallax("50% 50%", 0.01);
		jQuery('#future_1').parallax("50% 50%", 0.01);
		jQuery('#team').parallax("50% 50%", 0.01);
...
jQuery(window).load(function(){
	...
	$('#accordion').on('hide.bs.collapse show.bs.collapse', function () {
		  $(this).trigger('resize');
		});
	...
	var headerOffset = jQuery('#topline').outerHeight(true) + jQuery('#info').outerHeight(true);
